...
//Base Case
// let origText = 'So, keep working. Keep striving. Never give up. Fall down seven times, ' + 
//                 'get up eight. Ease is a greater threat to progress than hardship. Ease is a ' +
//                 'greater threat to progress than hardship. So, keep moving, keep growing, ' + 
//                 'keep learning. See you at work.'

//USAA Tornado Article
// let origText = 'Chances are that you’ll never experience a tornado unless you live in certain parts of the country, like the Great Plains or the Gulf Coast, or you happen to chase storms for a living. And good for you if you never have to worry about them.' +
...
// let origText = 'When we think about taking care of ourselves, we tend to consider only our physical well-being. But what about your current state of mind? It impacts your day-to-day life much more than you realize.' +
...
function weightText(text){
    ...
    let sentences = origText.match(/([^\.!\?]+[\.!\?]+)|([^\.!\?]+$)/g);

    //Regex to remove all special characters
    let noSpecialsText = origText.replace(/[^a-zA-Z0-9 ]/g, '');
